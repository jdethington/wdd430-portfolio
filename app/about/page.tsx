    ...
    <div className="container mx-auto px-4 py-8">
      <section className="text-center py-12">
        ...
        <p className="text-large text-gray-700">
          I am a former dairy farmer and now a full-stack web developer. I have
          a passion for creating innovative solutions and learning new
          technologies. Below are some of my first projects that show where I
          started my journey.
        </p>
      </section>
